...
$SETTINGS['NOU']['HowToShortCodes']['es'] = "Ambos shortcodes puede ser utilizados con par&aacute;metros para sobrescribir los de default:
<li type=square><code>img=&quot;image.name&quot;</code> sobrescribe la imagen de default. Controle que el nombre de la imagen sea correcto!</li>
<li type=square><code>max=10</code> sobrescribe el valor m&aacute;ximo de estrellas por evaluacion</li>
<li type=square><code>size=20</code> sobrescribe el valor tama&ntilde;o de la estrella</li>
<li type=square><code>text=false</code> sobrescribe la opci&oacute;n para el texto base en output (su valor puede ser solo &quot;true&quot; o &quot;false&quot;)</li>
<li type=square><code>tooltip=false</code> sobrescribe la opci&oacute;n para el texto base en output como Tooltip (su valor puede ser solo &quot;true&quot; o &quot;false&quot;)</li>
El shortcode para inserir una lista de Universal Star Ratings puede ser utilizado tambien con otros parametros:
<li type=square><code>avg=true</code> sobrescribe la opci&oacute;n para el c&aacute;lculo del promedio de la evaluaci&oacute;n (su valor puede ser solo &quot;true&quot; o &quot;false&quot;)</li>";
...
$SETTINGS['OPT']['ExplainTextAsTooltip']['es'] = "Texto como Tooltip";
...
$SETTINGS['OPT']['ExplainSchemaOrgType']['es'] = "Schema.org rating tipo";
...
$SETTINGS['OPT']['DefaultTextAsTooltip']['es'] = "<em>Est&aacute;ndar: <code>Deshabilitado</code></em>";
...
$SETTINGS['OPT']['DefaultSchemaOrgType']['es'] = "<em>Est&aacute;ndar: <code>reviewRating</code></em>";
...
$SETTINGS['PREV']['ExampleUsrOverriddenTooltipTrue']['es'] = "Pel&iacute;cula: [usr 3.5 text=&quot;true&quot; tooltip=&quot;true&quot;]";
$SETTINGS['PREV']['ExampleUsrOverriddenTooltipFalse']['es'] = "Pel&iacute;cula: [usr 3.5 text=&quot;true&quot; tooltip=&quot;false&quot;]";
